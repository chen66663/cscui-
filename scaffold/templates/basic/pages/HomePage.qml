...
Page {
            ...
            MouseArea {
                ...
                onClicked: {
                    animationWrapper.open(gridButton,
                                          window.theme.localized("Animated window", "动画窗口"))
    ...
    AnimatedWindow {
        id: animationWrapper
        theme: window.theme
        windowTitle: window.theme.localized("Animated window", "动画窗口")

        ColumnLayout {
            anchors.centerIn: parent
            spacing: window.theme.spacingSmall

            Label {
                Layout.alignment: Qt.AlignHCenter
                text: window.theme.localized("Animated window", "动画窗口")
                color: window.theme.textColor
                font.pixelSize: window.theme.fontSizeHeading
                font.bold: true
            }

            Label {
                Layout.alignment: Qt.AlignHCenter
                text: window.theme.localized("Press Esc or use the close button to return.",
                                             "按 Esc 或点击关闭按钮返回。")
                color: window.theme.secondaryTextColor
            }
        }
    }
